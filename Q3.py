...
volume_1 = Conv2D(64, (1,1), padding='same', activation='relu',kernel_regularizer=regularizers.l2(0.05))(input_img)
...
volume_5 = Conv2D(16, (1,1), padding='same', activation='relu')(volume_4)
volume_5 = Conv2D(32, (5,5), padding='same', activation='relu')(volume_5)
