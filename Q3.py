...
# Create Volumes for the Inception module
volume_a = Conv2D(64, (1,1), padding='same', activation='relu',kernel_regularizer=regularizers.l1(0.06),activity_regularizer = regularizers.l2(0.05))(output)

volume_b = Conv2D(96, (1,1), padding='same', activation='relu')(output)
volume_b = Conv2D(128, (3,3), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.06),activity_regularizer = regularizers.l2(0.05))(volume_b)

volume_c = Conv2D(16, (1,1), padding='same', activation='relu')(output)
volume_c = Conv2D(32, (5,5), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.06),activity_regularizer = regularizers.l2(0.05))(volume_c)

volume_d = MaxPooling2D((3,3), strides=(1,1), padding='same')(output)
volume_d = Conv2D(32, (2,2), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.06),activity_regularizer = regularizers.l2(0.05))(volume_d)
