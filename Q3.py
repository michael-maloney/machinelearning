...
volume_3 = Conv2D(16, (1,1), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.05))(input_img)
volume_3 = Conv2D(32, (3,3), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.05))(volume_3)
...
# Create Volumes for the Inception module
volume_a = Conv2D(64, (1,1), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.05))(output)

volume_b = Conv2D(96, (1,1), padding='same', activation='relu', kernel_regularizer=regularizers.l1(0.05))(output)
